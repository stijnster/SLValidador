...
-(void)testVariousNumbers{
    ...
    XCTAssert([validador vNif:@"A58818501"] == SLValidador_CIF_NORESIDENTES_OK, "wrong answer");
    XCTAssert([validador vNif:@"38119995W"] == SLValidador_NIF_OK, "wrong answer");
    XCTAssert([validador vNif:@"F08216863"] == SLValidador_CIF_NORESIDENTES_OK, "wrong answer");
    ...
    //NIES1
    XCTAssert([validador vNif:@"Z5208783R"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"Y9385597R"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"Z6716416F"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"X6514670N"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"Z3294580L"] == SLValidador_NIF_EXTRANJEROS, "wrong answer");
    XCTAssert([validador vNif:@"Y2718340F"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"Z4555342J"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"Z4572024C"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"Y7613762V"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"X3953244G"] == SLValidador_CIF_ERROR_DC, "wrong answer");

    //NIES2
    XCTAssert([validador vNif:@"X5965007A"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    ...
    XCTAssert([validador vNif:@"Z4621338E"] == SLValidador_CIF_EXTRANJERO_OK, "wrong answer");
    XCTAssert([validador vNif:@"X1699388X"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"Y2388638X"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"X0187312T"] == SLValidador_NIF_EXTRANJEROS, "wrong answer");
    XCTAssert([validador vNif:@"X8099942D"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"X2936278Y"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    XCTAssert([validador vNif:@"X3685367P"] == SLValidador_CIF_ERROR_DC, "wrong answer");
    
    //CIFS1
    XCTAssert([validador vNif:@"H06321491"] == SLValidador_CIF_NORESIDENTES_OK, "wrong answer");
    XCTAssert([validador vNif:@"C78970670"] == SLValidador_CIF_NORESIDENTES_OK, "wrong answer");
    XCTAssert([validador vNif:@"H24647794"] == SLValidador_CIF_NORESIDENTES_OK, "wrong answer");
    XCTAssert([validador vNif:@"B73081317"] == SLValidador_CIF_NORESIDENTES_OK, "wrong answer");
    ...
    XCTAssert([validador vNif:@"J3574987H"] == SLValidador_CIF_ORGANIZACION_OK, "wrong answer");
    XCTAssert([validador vNif:@"D2086707C"] == SLValidador_CIF_EXTRANJERO_OK, "wrong answer");
    
    //CIFS2
    XCTAssert([validador vNif:@"B55294839"] == SLValidador_CIF_NORESIDENTES_OK, "wrong answer");
    ...
    XCTAssert([validador vNif:@"B07080641"] == SLValidador_CIF_NORESIDENTES_OK, "wrong answer");
    ...
    XCTAssert([validador vNif:@"F79247318"] == SLValidador_CIF_NORESIDENTES_OK, "wrong answer");
    XCTAssert([validador vNif:@"S6981484F"] == SLValidador_CIF_ORGANIZACION_OK, "wrong answer");
    XCTAssert([validador vNif:@"V7937974I"] == SLValidador_CIF_ORGANIZACION_OK, "wrong answer");
}
